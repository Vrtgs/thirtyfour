...
impl OperaCapabilities {
    ...
    /// Add the specified command-line argument to `operadriver`.
    ///
    /// ## Example
    ///
    /// ```ignore
    ...
    /// Remove the specified Opera command-line argument if it had been added previously.
