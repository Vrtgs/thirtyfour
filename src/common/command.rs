...
pub enum Command<'a> {
    ...
    SwitchToFrame(&'a SessionId, ElementId),
    ...
    GetElementCSSValue(&'a SessionId, ElementId, String),
    GetElementText(&'a SessionId, ElementId),
    GetElementTagName(&'a SessionId, ElementId),
    GetElementRect(&'a SessionId, ElementId),
    IsElementEnabled(&'a SessionId, ElementId),
    ElementClick(&'a SessionId, ElementId),
    ...
    TakeElementScreenshot(&'a SessionId, ElementId),
}
